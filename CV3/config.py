...
class BoardAnalyzerConfig:
    ...
    hand_contour_threshold: float = 1800.0  # Minimum contour density
    hand_canny_low: int = 50  # Canny edge detection lower threshold
    hand_canny_high: int = 100  # Canny edge detection higher threshold
    hand_detection_outer_margin: float = 0.25  # Outer margin as fraction of big_cropped size (e.g., 0.1 = 10%)
    ...
    display_text_color: tuple = (0, 255, 0)  # BGR format